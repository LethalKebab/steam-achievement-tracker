 ...
 * ------------------------------------------------
 *   games        — one row per appid: name, unlocked/total, completion rate, status, ♥/★/family marks
...
/** Insert a game row. Does nothing if it already exists (never overwrites existing manual marks); returns whether a row was actually inserted */

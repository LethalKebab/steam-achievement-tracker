  ...
  replaceAchievements(
    ...
    cn.map((a) => {
      ...
      return {
        ...
        // The English schema was already fetched two lines up for the name; its description came
        // with it and used to be dropped on the floor. Same '' for a hidden achievement, for the
        // same reason: the description is the spoiler, in either language
        descriptionEn: hidden ? '' : enByApiName[a.name]?.description || '',
        hidden,

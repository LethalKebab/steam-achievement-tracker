 ...
 *
 * Why that is wrong is in SKILL.md rule 一: in Notion only the first bracket at the start of a line
...
/** SKILL.md rule 七: a guide's prose does not state where its data came from */
 ...
 * in SKILL.md rule 十, item 16, is no longer necessary.
 *

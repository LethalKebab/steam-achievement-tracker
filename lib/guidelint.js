 ...
 *
 * **Attachment is decided by `todoSpansWithToggles` — the function partial rewriting actually uses**
 * — rather than by a lookalike "is the line above a checkbox" test. The question being asked is
 * exactly "will a rewrite of this achievement carry this fold along", and only that function answers
 * it; a second implementation would eventually answer differently and the disagreement would surface
 * as text left stranded in a rewritten guide.
 *

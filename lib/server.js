...
export function createGuideGenState() {
  const idle = {
     ...
     * 「第 3 段没写出来」 has to stay until somebody sees it at the end. Same reason as syncState's
  ...
  return {
    ...
    warn(note) {
       ...
       *
       * `warnings` travels with it: those sentences ("第 3 段没写出来") describe **what is missing

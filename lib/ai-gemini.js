 ...
 *
 * **That measurement does not cover a guide-sized request, and something there is worse.** In the
 * same window, `ai-check` went through while a real generation lost all six attempts, twice. So the
 * odds below are a floor for the small case, not a description of the big one; do not quote them as
 * "Gemini succeeds 40% of the time" without measuring the request you actually care about.
 *
